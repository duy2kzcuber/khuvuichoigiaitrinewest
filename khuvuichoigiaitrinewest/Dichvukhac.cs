...
{
    public partial class Dichvukhac : Form
    {
        ...
        private void Load_dgvdv_dichvukhac()
        {
        ...
        private bool Checktrungma(string p_ma)
        {
            ...
            string sql = "Select count(*) From dv_khac where ma_dv='" + p_ma + "'";
            SqlCommand cmd = new SqlCommand(sql, con);
        ...
        private void luu_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string sql = "Insert dv_khac Values('" + p_ma1 + "',N'" + p_ten + "',N'" + p_theloai + "','" + p_dateopen + "','" + p_dateclose + "','" + p_giavenl + "','" + p_giavetreem + "',N'" + p_tt + "',N'" + p_mota + "','" + p_anh + "')";
                SqlCommand cmd = new SqlCommand(sql, con);
                cmd.ExecuteNonQuery();
                cmd.Dispose();
                con.Close();
        ...
        private void textanh_TextChanged_1(object sender, EventArgs e)
        {
        ...
        private void xoa_Click(object sender, EventArgs e)
        {
            ...
            string sql = "Delete dv_khac where ma_dv='" + p_ma1 + "'";
            SqlCommand cmd = new SqlCommand(sql, con);
            SqlDataAdapter da = new SqlDataAdapter();
        ...
        private void dataGridView2_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            texttendv.Text = dataGridView2.Rows[i].Cells[1].Value.ToString();
        ...
        private void timkiem_Click(object sender, EventArgs e)
        {
            ...
            string sql = "Select * from dv_khac  where ma_dv like '%" + p_ma1 + "%' ";
        ...
        private void ExportExcel(DataTable tb, string sheetname)
        {
            ...
            head.Value2 = "DANH SÁCH DICH VU KHAC";
